-- TPC-H Benchmark Queries for BigQuery Standard SQL
-- Run with: bq query --use_legacy_sql=false --dataset_id=zaad-demo:TPCH_SF10 < query.sql
-- Or replace TPCH_SF10 with TPCH_SF100 for scale factor 100
