-- TPC-DS All Queries - TPCDS_10GB
OPEN SCHEMA TPCDS_10GB;
...
WITH customer_total_return AS (
  ...
  FROM TPCDS_10GB.STORE_RETURNS, TPCDS_10GB.DATE_DIM
  WHERE sr_returned_date_sk = d_date_sk AND d_year = 2000
  GROUP BY sr_customer_sk, sr_store_sk
)
SELECT c_customer_id
FROM customer_total_return ctr1, TPCDS_10GB.STORE, TPCDS_10GB.CUSTOMER
...
WITH wscs AS (
  SELECT sold_date_sk, sales_price FROM (
    SELECT ws_sold_date_sk AS sold_date_sk, ws_ext_sales_price AS sales_price FROM TPCDS_10GB.WEB_SALES
    UNION ALL
    SELECT cs_sold_date_sk AS sold_date_sk, cs_ext_sales_price AS sales_price FROM TPCDS_10GB.CATALOG_SALES
  ) x
),
wswscs AS (
  ...
  FROM wscs, TPCDS_10GB.DATE_DIM WHERE d_date_sk = sold_date_sk GROUP BY d_week_seq
)
...
FROM (SELECT wswscs.d_week_seq AS d_week_seq, sun_sales AS sun_sales1, mon_sales AS mon_sales1, tue_sales AS tue_sales1, wed_sales AS wed_sales1, thu_sales AS thu_sales1, fri_sales AS fri_sales1, sat_sales AS sat_sales1 FROM wswscs, TPCDS_10GB.DATE_DIM d1 WHERE d1.d_week_seq = wswscs.d_week_seq AND d1.d_year = 2001) y1,
(SELECT wswscs.d_week_seq AS d_week_seq, sun_sales AS sun_sales2, mon_sales AS mon_sales2, tue_sales AS tue_sales2, wed_sales AS wed_sales2, thu_sales AS thu_sales2, fri_sales AS fri_sales2, sat_sales AS sat_sales2 FROM wswscs, TPCDS_10GB.DATE_DIM d2 WHERE d2.d_week_seq = wswscs.d_week_seq AND d2.d_year = 2001 + 1) y2
...
WITH year_total AS (
  ...
  FROM TPCDS_10GB.CUSTOMER, TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM
  ...
  FROM TPCDS_10GB.CUSTOMER, TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.DATE_DIM
  ...
  FROM TPCDS_10GB.CUSTOMER, TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM
...
WITH ssr AS (
  ...
  FROM TPCDS_10GB.STORE_SALES LEFT JOIN TPCDS_10GB.STORE_RETURNS ON ss_item_sk = sr_item_sk AND ss_ticket_number = sr_ticket_number,
    TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE
...
csr AS (
  ...
  FROM TPCDS_10GB.CATALOG_SALES LEFT JOIN TPCDS_10GB.CATALOG_RETURNS ON cs_item_sk = cr_item_sk AND cs_order_number = cr_order_number,
    TPCDS_10GB.DATE_DIM, TPCDS_10GB.CATALOG_PAGE
...
wsr AS (
  ...
  FROM TPCDS_10GB.WEB_SALES LEFT JOIN TPCDS_10GB.WEB_RETURNS ON ws_item_sk = wr_item_sk AND ws_order_number = wr_order_number,
    TPCDS_10GB.DATE_DIM, TPCDS_10GB.WEB_SITE
...
FROM TPCDS_10GB.CUSTOMER_ADDRESS a, TPCDS_10GB.CUSTOMER c, TPCDS_10GB.STORE_SALES s, TPCDS_10GB.DATE_DIM d, TPCDS_10GB.ITEM i
WHERE a.ca_address_sk = c.c_current_addr_sk AND c.c_customer_sk = s.ss_customer_sk AND s.ss_sold_date_sk = d.d_date_sk AND s.ss_item_sk = i.i_item_sk AND d.d_month_seq = (SELECT DISTINCT d_month_seq FROM TPCDS_10GB.DATE_DIM WHERE d_year = 2001 AND d_moy = 1)
AND i.i_current_price > 1.2 * (SELECT AVG(j.i_current_price) FROM TPCDS_10GB.ITEM j WHERE j.i_category = i.i_category)
GROUP BY a.ca_state
HAVING COUNT(*) >= 10
...
FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.ITEM, TPCDS_10GB.PROMOTION
...
SELECT CASE WHEN (SELECT COUNT(*) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 1 AND 20) > 74129 THEN (SELECT AVG(ss_ext_discount_amt) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 1 AND 20) ELSE (SELECT AVG(ss_net_paid) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 1 AND 20) END bucket1,
CASE WHEN (SELECT COUNT(*) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 21 AND 40) > 122840 THEN (SELECT AVG(ss_ext_discount_amt) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 21 AND 40) ELSE (SELECT AVG(ss_net_paid) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 21 AND 40) END bucket2,
CASE WHEN (SELECT COUNT(*) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 41 AND 60) > 56580 THEN (SELECT AVG(ss_ext_discount_amt) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 41 AND 60) ELSE (SELECT AVG(ss_net_paid) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 41 AND 60) END bucket3,
CASE WHEN (SELECT COUNT(*) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 61 AND 80) > 10097 THEN (SELECT AVG(ss_ext_discount_amt) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 61 AND 80) ELSE (SELECT AVG(ss_net_paid) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 61 AND 80) END bucket4,
CASE WHEN (SELECT COUNT(*) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 81 AND 100) > 165306 THEN (SELECT AVG(ss_ext_discount_amt) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 81 AND 100) ELSE (SELECT AVG(ss_net_paid) FROM TPCDS_10GB.STORE_SALES WHERE ss_quantity BETWEEN 81 AND 100) END bucket5
FROM TPCDS_10GB.REASON
WHERE r_reason_sk = 1;
...
AND EXISTS (SELECT * FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM WHERE c.c_customer_sk = ss_customer_sk AND ss_sold_date_sk = d_date_sk AND d_year = 2002 AND d_moy BETWEEN 1 AND 1+3)
AND (EXISTS (SELECT * FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM WHERE c.c_customer_sk = ws_bill_customer_sk AND ws_sold_date_sk = d_date_sk AND d_year = 2002 AND d_moy BETWEEN 1 AND 1+3)
  OR EXISTS (SELECT * FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.DATE_DIM WHERE c.c_customer_sk = cs_ship_customer_sk AND cs_sold_date_sk = d_date_sk AND d_year = 2002 AND d_moy BETWEEN 1 AND 1+3))
...
FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.DATE_DIM
...
FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.CUSTOMER, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.DATE_DIM
...
FROM TPCDS_10GB.CATALOG_SALES cs1, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.CALL_CENTER
...
AND cs1.cs_call_center_sk = cc_call_center_sk AND cc_county IN ('Williamson County', 'Ziebach County', 'Walker County', 'Ziebach County', 'Ziebach County')
AND EXISTS (SELECT * FROM TPCDS_10GB.CATALOG_SALES cs2 WHERE cs1.cs_order_number = cs2.cs_order_number AND cs1.cs_warehouse_sk <> cs2.cs_warehouse_sk)
AND NOT EXISTS (SELECT * FROM TPCDS_10GB.CATALOG_RETURNS cr1 WHERE cs1.cs_order_number = cr1.cr_order_number)
...
FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS, TPCDS_10GB.CUSTOMER, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.ITEM
...
FROM TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE_SALES, TPCDS_10GB.ITEM, TPCDS_10GB.CUSTOMER, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.STORE
...
SELECT * FROM (
  ...
  FROM TPCDS_10GB.INVENTORY, TPCDS_10GB.WAREHOUSE, TPCDS_10GB.ITEM, TPCDS_10GB.DATE_DIM
...
WITH frequent_ss_items AS (
  ...
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM, TPCDS_10GB.ITEM
...
best_ss_customer AS (
  ...
  FROM TPCDS_10GB.CUSTOMER, TPCDS_10GB.STORE_SALES
...
SELECT SUM(sales) total_sales FROM (
  ...
  FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM
...
WITH ssales AS (
  ...
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE_RETURNS, TPCDS_10GB.STORE, TPCDS_10GB.ITEM, TPCDS_10GB.CUSTOMER, TPCDS_10GB.CUSTOMER_ADDRESS
...
FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.ITEM, TPCDS_10GB.PROMOTION
...
FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE, TPCDS_10GB.ITEM
WHERE ss_sold_date_sk = d_date_sk AND ss_item_sk = i_item_sk AND ss_store_sk = s_store_sk AND ss_cdemo_sk = cd_demo_sk
AND cd_gender = 'M' AND cd_marital_status = 'S' AND cd_education_status = 'College'
AND d_year = 2002 AND s_state IN ('TN', 'SD', 'AL', 'SD', 'SD', 'SD')
...
WITH customer_total_return AS (
  ...
  FROM TPCDS_10GB.WEB_RETURNS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER_ADDRESS
...
FROM customer_total_return ctr1, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.CUSTOMER
...
WITH ss AS (
  ...
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER_ADDRESS
  WHERE ss_sold_date_sk = d_date_sk AND ss_addr_sk = ca_address_sk
  GROUP BY ca_county, d_qoy, d_year
),
ws AS (
  SELECT ca_county, d_qoy, d_year, SUM(ws_ext_sales_price) AS web_sales
  FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER_ADDRESS
...
AND cs_ext_discount_amt > (
  SELECT 1.3 * AVG(cs_ext_discount_amt) FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.DATE_DIM
...
AND EXISTS (SELECT * FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM WHERE c.c_customer_sk = ss_customer_sk AND ss_sold_date_sk = d_date_sk AND d_year = 2002 AND d_qoy < 4)
AND (EXISTS (SELECT * FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM WHERE c.c_customer_sk = ws_bill_customer_sk AND ws_sold_date_sk = d_date_sk AND d_year = 2002 AND d_qoy < 4)
  OR EXISTS (SELECT * FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.DATE_DIM WHERE c.c_customer_sk = cs_ship_customer_sk AND cs_sold_date_sk = d_date_sk AND d_year = 2002 AND d_qoy < 4))
...
FROM TPCDS_10GB.ITEM, TPCDS_10GB.INVENTORY, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CATALOG_SALES
...
FROM TPCDS_10GB.ITEM i1
WHERE i_manufact_id BETWEEN 738 AND 738+40
AND (SELECT COUNT(*) AS item_cnt FROM TPCDS_10GB.ITEM
...
FROM TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE
...
FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.DATE_DIM
...
SELECT channel, item, return_ratio, return_rank, currency_rank FROM (
  ...
  FROM (
    ...
    FROM (
      ...
      FROM TPCDS_10GB.WEB_SALES ws LEFT OUTER JOIN TPCDS_10GB.WEB_RETURNS wr ON ws.ws_order_number = wr.wr_order_number AND ws.ws_item_sk = wr.wr_item_sk,
        TPCDS_10GB.DATE_DIM WHERE wr.wr_return_amt > 10000 AND ws.ws_net_profit > 1 AND ws.ws_net_paid > 0 AND ws.ws_quantity > 0 AND ws_sold_date_sk = d_date_sk AND d_year = 2001 AND d_moy = 12
  ...
  FROM (
    ...
    FROM (
      ...
      FROM TPCDS_10GB.CATALOG_SALES csales LEFT OUTER JOIN TPCDS_10GB.CATALOG_RETURNS cret ON csales.cs_order_number = cret.cr_order_number AND csales.cs_item_sk = cret.cr_item_sk,
        TPCDS_10GB.DATE_DIM WHERE cret.cr_return_amount > 10000 AND csales.cs_net_profit > 1 AND csales.cs_net_paid > 0 AND csales.cs_quantity > 0 AND cs_sold_date_sk = d_date_sk AND d_year = 2001 AND d_moy = 12
  ...
  FROM (
    ...
    FROM (
      ...
      FROM TPCDS_10GB.STORE_SALES sts LEFT OUTER JOIN TPCDS_10GB.STORE_RETURNS sr ON sts.ss_ticket_number = sr.sr_ticket_number AND sts.ss_item_sk = sr.sr_item_sk,
        TPCDS_10GB.DATE_DIM WHERE sr.sr_return_amt > 10000 AND sts.ss_net_profit > 1 AND sts.ss_net_paid > 0 AND sts.ss_quantity > 0 AND ss_sold_date_sk = d_date_sk AND d_year = 2001 AND d_moy = 12
...
FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE_RETURNS, TPCDS_10GB.STORE, TPCDS_10GB.DATE_DIM d1, TPCDS_10GB.DATE_DIM d2
...
WITH my_customers AS (
  ...
  FROM (
    ...
    FROM TPCDS_10GB.WEB_SALES
  ) cs_or_ws_sales, TPCDS_10GB.ITEM, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER
...
my_revenue AS (
  ...
  FROM my_customers, TPCDS_10GB.STORE_SALES, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.STORE, TPCDS_10GB.DATE_DIM
  WHERE c_current_addr_sk = ca_address_sk AND ca_county = s_county AND ca_state = s_state
  AND ss_sold_date_sk = d_date_sk AND c_customer_sk = ss_customer_sk AND d_month_seq BETWEEN (SELECT DISTINCT d_month_seq+1 FROM TPCDS_10GB.DATE_DIM WHERE d_year = 1998 AND d_moy = 12) AND (SELECT DISTINCT d_month_seq+3 FROM TPCDS_10GB.DATE_DIM WHERE d_year = 1998 AND d_moy = 12)
  GROUP BY c_customer_sk
)
...
WITH v1 AS (
  ...
  FROM TPCDS_10GB.ITEM, TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CALL_CENTER
...
SELECT i_item_id, SUM(total_sales) total_sales FROM (
  SELECT i_item_id, SUM(ss_ext_sales_price) total_sales
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.ITEM
  WHERE i_item_id IN (SELECT i_item_id FROM TPCDS_10GB.ITEM WHERE i_category IN ('Music'))
...
FROM (
  ...
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE, TPCDS_10GB.PROMOTION, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.ITEM
...
(SELECT SUM(ss_ext_sales_price) total
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.ITEM
...
FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.WAREHOUSE, TPCDS_10GB.SHIP_MODE, TPCDS_10GB.WEB_SITE, TPCDS_10GB.DATE_DIM
...
WITH cs_ui AS (
  ...
  FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.CATALOG_RETURNS
...
cross_sales AS (
  ...
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE_RETURNS, cs_ui, TPCDS_10GB.DATE_DIM d1, TPCDS_10GB.DATE_DIM d2, TPCDS_10GB.DATE_DIM d3, TPCDS_10GB.STORE, TPCDS_10GB.CUSTOMER,
    TPCDS_10GB.CUSTOMER_DEMOGRAPHICS cd1, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS cd2, TPCDS_10GB.PROMOTION, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS hd1, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS hd2,
    TPCDS_10GB.CUSTOMER_ADDRESS ad1, TPCDS_10GB.CUSTOMER_ADDRESS ad2, TPCDS_10GB.INCOME_BAND ib1, TPCDS_10GB.INCOME_BAND ib2, TPCDS_10GB.ITEM
...
FROM TPCDS_10GB.STORE, TPCDS_10GB.ITEM,
...
FROM (
  ...
  FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.WAREHOUSE, TPCDS_10GB.DATE_DIM, TPCDS_10GB.TIME_DIM, TPCDS_10GB.SHIP_MODE
  ...
  FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.WAREHOUSE, TPCDS_10GB.DATE_DIM, TPCDS_10GB.TIME_DIM, TPCDS_10GB.SHIP_MODE
...
SELECT * FROM (
  ...
  FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE, TPCDS_10GB.ITEM
...
FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM d1, TPCDS_10GB.STORE
...
AND s_state IN (
  SELECT s_state FROM (
    ...
    FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.STORE, TPCDS_10GB.DATE_DIM
...
FROM TPCDS_10GB.ITEM,
  (SELECT ws_ext_sales_price AS ext_price, ws_sold_date_sk AS sold_date_sk, ws_item_sk AS sold_item_sk, ws_sold_time_sk AS time_sk FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM WHERE d_date_sk = ws_sold_date_sk AND d_moy = 11 AND d_year = 1999
   UNION ALL
   SELECT cs_ext_sales_price AS ext_price, cs_sold_date_sk AS sold_date_sk, cs_item_sk AS sold_item_sk, cs_sold_time_sk AS time_sk FROM TPCDS_10GB.CATALOG_SALES, TPCDS_10GB.DATE_DIM WHERE d_date_sk = cs_sold_date_sk AND d_moy = 11 AND d_year = 1999
   UNION ALL
   SELECT ss_ext_sales_price AS ext_price, ss_sold_date_sk AS sold_date_sk, ss_item_sk AS sold_item_sk, ss_sold_time_sk AS time_sk FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.DATE_DIM WHERE d_date_sk = ss_sold_date_sk AND d_moy = 11 AND d_year = 1999
  ) tmp, TPCDS_10GB.TIME_DIM
...
WITH all_sales AS (
  ...
  FROM (
    ...
    FROM TPCDS_10GB.CATALOG_SALES JOIN TPCDS_10GB.ITEM ON i_item_sk = cs_item_sk JOIN TPCDS_10GB.DATE_DIM ON d_date_sk = cs_sold_date_sk LEFT JOIN TPCDS_10GB.CATALOG_RETURNS ON cs_order_number = cr_order_number AND cs_item_sk = cr_item_sk
    ...
    FROM TPCDS_10GB.STORE_SALES JOIN TPCDS_10GB.ITEM ON i_item_sk = ss_item_sk JOIN TPCDS_10GB.DATE_DIM ON d_date_sk = ss_sold_date_sk LEFT JOIN TPCDS_10GB.STORE_RETURNS ON ss_ticket_number = sr_ticket_number AND ss_item_sk = sr_item_sk
    WHERE i_category = 'Books'
    UNION ALL
    ...
    FROM TPCDS_10GB.WEB_SALES JOIN TPCDS_10GB.ITEM ON i_item_sk = ws_item_sk JOIN TPCDS_10GB.DATE_DIM ON d_date_sk = ws_sold_date_sk LEFT JOIN TPCDS_10GB.WEB_RETURNS ON ws_order_number = wr_order_number AND ws_item_sk = wr_item_sk
    WHERE i_category = 'Books'
  ) sales_detail
...
sr AS (
  ...
  FROM TPCDS_10GB.STORE_RETURNS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE
...
cret AS (
  ...
  FROM TPCDS_10GB.CATALOG_RETURNS, TPCDS_10GB.DATE_DIM
...
ws AS (
  ...
  FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM, TPCDS_10GB.WEB_PAGE
...
wr AS (
  ...
  FROM TPCDS_10GB.WEB_RETURNS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.WEB_PAGE
...
WITH ssr AS (
  ...
  FROM TPCDS_10GB.STORE_SALES LEFT OUTER JOIN TPCDS_10GB.STORE_RETURNS ON ss_item_sk = sr_item_sk AND ss_ticket_number = sr_ticket_number,
    TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE, TPCDS_10GB.ITEM, TPCDS_10GB.PROMOTION
...
csr AS (
  ...
  FROM TPCDS_10GB.CATALOG_SALES LEFT OUTER JOIN TPCDS_10GB.CATALOG_RETURNS ON cs_item_sk = cr_item_sk AND cs_order_number = cr_order_number,
    TPCDS_10GB.DATE_DIM, TPCDS_10GB.CATALOG_PAGE, TPCDS_10GB.ITEM, TPCDS_10GB.PROMOTION
...
wsr AS (
  ...
  FROM TPCDS_10GB.WEB_SALES LEFT OUTER JOIN TPCDS_10GB.WEB_RETURNS ON ws_item_sk = wr_item_sk AND ws_order_number = wr_order_number,
    TPCDS_10GB.DATE_DIM, TPCDS_10GB.WEB_SITE, TPCDS_10GB.ITEM, TPCDS_10GB.PROMOTION
...
WITH customer_total_return AS (
  ...
  FROM TPCDS_10GB.CATALOG_RETURNS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER_ADDRESS
...
SELECT i_item_id, i_item_desc, i_current_price
FROM TPCDS_10GB.ITEM, TPCDS_10GB.INVENTORY, TPCDS_10GB.DATE_DIM, TPCDS_10GB.STORE_SALES
...
WITH sr_items AS (
  ...
  FROM TPCDS_10GB.STORE_RETURNS, TPCDS_10GB.ITEM, TPCDS_10GB.DATE_DIM
  WHERE sr_item_sk = i_item_sk AND d_date IN (SELECT d_date FROM TPCDS_10GB.DATE_DIM WHERE d_week_seq IN (SELECT d_week_seq FROM TPCDS_10GB.DATE_DIM WHERE d_date IN (DATE '2000-06-30', DATE '2000-09-27', DATE '2000-11-17')))
  AND sr_returned_date_sk = d_date_sk
  GROUP BY i_item_id
),
cr_items AS (
  SELECT i_item_id item_id, SUM(cr_return_quantity) cr_item_qty
  FROM TPCDS_10GB.CATALOG_RETURNS, TPCDS_10GB.ITEM, TPCDS_10GB.DATE_DIM
  WHERE cr_item_sk = i_item_sk AND d_date IN (SELECT d_date FROM TPCDS_10GB.DATE_DIM WHERE d_week_seq IN (SELECT d_week_seq FROM TPCDS_10GB.DATE_DIM WHERE d_date IN (DATE '2000-06-30', DATE '2000-09-27', DATE '2000-11-17')))
  AND cr_returned_date_sk = d_date_sk
  GROUP BY i_item_id
),
wr_items AS (
  SELECT i_item_id item_id, SUM(wr_return_quantity) wr_item_qty
  FROM TPCDS_10GB.WEB_RETURNS, TPCDS_10GB.ITEM, TPCDS_10GB.DATE_DIM
  WHERE wr_item_sk = i_item_sk AND d_date IN (SELECT d_date FROM TPCDS_10GB.DATE_DIM WHERE d_week_seq IN (SELECT d_week_seq FROM TPCDS_10GB.DATE_DIM WHERE d_date IN (DATE '2000-06-30', DATE '2000-09-27', DATE '2000-11-17')))
...
FROM TPCDS_10GB.WEB_SALES, TPCDS_10GB.DATE_DIM d1, TPCDS_10GB.ITEM
...
SELECT * FROM (
  SELECT COUNT(*) h8_30_to_9 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
...
(SELECT COUNT(*) h9_to_9_30 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
...
(SELECT COUNT(*) h9_30_to_10 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
  WHERE ss_sold_time_sk = time_dim.t_time_sk AND ss_hdemo_sk = household_demographics.hd_demo_sk AND ss_store_sk = s_store_sk AND time_dim.t_hour = 9 AND time_dim.t_minute >= 30
  AND ((household_demographics.hd_dep_count = 4 AND household_demographics.hd_vehicle_count <= 4+2) OR (household_demographics.hd_dep_count = 2 AND household_demographics.hd_vehicle_count <= 2+2) OR (household_demographics.hd_dep_count = 0 AND household_demographics.hd_vehicle_count <= 0+2))
  AND store.s_store_name = 'ese'
) s3,
(SELECT COUNT(*) h10_to_10_30 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
...
(SELECT COUNT(*) h10_30_to_11 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
  WHERE ss_sold_time_sk = time_dim.t_time_sk AND ss_hdemo_sk = household_demographics.hd_demo_sk AND ss_store_sk = s_store_sk AND time_dim.t_hour = 10 AND time_dim.t_minute >= 30
  AND ((household_demographics.hd_dep_count = 4 AND household_demographics.hd_vehicle_count <= 4+2) OR (household_demographics.hd_dep_count = 2 AND household_demographics.hd_vehicle_count <= 2+2) OR (household_demographics.hd_dep_count = 0 AND household_demographics.hd_vehicle_count <= 0+2))
  AND store.s_store_name = 'ese'
) s5,
(SELECT COUNT(*) h11_to_11_30 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
...
(SELECT COUNT(*) h11_30_to_12 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
  WHERE ss_sold_time_sk = time_dim.t_time_sk AND ss_hdemo_sk = household_demographics.hd_demo_sk AND ss_store_sk = s_store_sk AND time_dim.t_hour = 11 AND time_dim.t_minute >= 30
  AND ((household_demographics.hd_dep_count = 4 AND household_demographics.hd_vehicle_count <= 4+2) OR (household_demographics.hd_dep_count = 2 AND household_demographics.hd_vehicle_count <= 2+2) OR (household_demographics.hd_dep_count = 0 AND household_demographics.hd_vehicle_count <= 0+2))
  AND store.s_store_name = 'ese'
) s7,
(SELECT COUNT(*) h12_to_12_30 FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
...
FROM TPCDS_10GB.CALL_CENTER, TPCDS_10GB.CATALOG_RETURNS, TPCDS_10GB.DATE_DIM, TPCDS_10GB.CUSTOMER, TPCDS_10GB.CUSTOMER_ADDRESS, TPCDS_10GB.CUSTOMER_DEMOGRAPHICS, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS
...
FROM (
  ...
  FROM TPCDS_10GB.STORE_SALES LEFT OUTER JOIN TPCDS_10GB.STORE_RETURNS ON sr_item_sk = ss_item_sk AND sr_ticket_number = ss_ticket_number,
    TPCDS_10GB.REASON
...
SELECT COUNT(*)
FROM TPCDS_10GB.STORE_SALES, TPCDS_10GB.HOUSEHOLD_DEMOGRAPHICS, TPCDS_10GB.TIME_DIM, TPCDS_10GB.STORE
